  ...
  function onMouseClick( event ) {
          ...
          if(modelChar != null){
            if ( ! isNaN( invisibleBox.position.angleTo(point) ) ){
              ...
              console.log(legL.rotation.x);
              console.log(legL.rotation.y);
              console.log(legL.rotation.z);
              console.log(legR.rotation.x);
              console.log(legR.rotation.y);
              console.log(legR.rotation.z);
              console.log(armL.rotation.x);
              console.log(armL.rotation.y);
              console.log(armL.rotation.z);
              console.log(armR.rotation.x);
              console.log(armR.rotation.y);
              console.log(armR.rotation.z);
